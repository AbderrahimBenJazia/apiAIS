...
const errorsDescription = {
  ...
  INCONNUE:
    "Une erreur inconnue est survenue, veuillez réessayer ultèrieurement",
  ...
  ERR_DGFIP_R2P_INCONNU:
    "Les informations du particulier ne permettent pas de le reconnaître dans l'annuaire des impôts. Veuillez vérifier que les informations indiquées correspondent à son avis d'imposition, ou essayez d'indiquer l'ensemble de ses prénoms, avec tiret, espace, etc.",
